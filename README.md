...
~/P/stegoc ❯❯❯ ./stegoc -d tmp/stuffed.png -o tmp/stuffed.key -c 1
Decoding RED channel of tmp/stuffed.png and outputting to tmp/stuffed.key
Success!

~/P/stegoc ❯❯❯ cat tmp/stuffed.key
-----BEGIN PGP PUBLIC KEY BLOCK-----
